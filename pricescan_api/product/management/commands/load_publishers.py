...
from product.models import Publisher
...
class Command(BaseCommand):
    help = "Импорт издателей из CSV (столбцы: id,name). Генерирует английские слаги."

    def add_arguments(self, parser):
        parser.add_argument(
            "--file",
            default=str(Path("product") / "data" / "publishers.csv"),
